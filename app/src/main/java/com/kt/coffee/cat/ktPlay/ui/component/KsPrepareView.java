...
public class KsPrepareView extends FrameLayout implements IControlComponent {
    ...
    public KsPrepareView(@NonNull Context context) {
        super(context);
    }

    public KsPrepareView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public KsPrepareView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public KsPrepareView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
    }

    {
        LayoutInflater.from(getContext()).inflate(R.layout.ktplayer_layout_prepare_view, this, true);
